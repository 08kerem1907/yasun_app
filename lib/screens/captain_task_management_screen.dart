            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // ✅ DÜZELTİLDİ: Nihai puan gösterimi
                  ...
                  children: [
                    ...
                    StreamBuilder<List<UserModel>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        if (!snapshot.hasData || snapshot.data!.isEmpty) {
                          return const Text('Takım üyesi bulunamadı.');
                        }
                        ...
                        if (assignableUsers.isEmpty) {
                          return const Text('Görev atanabilecek üye yok.');
                        }

                        // Eğer selectedUser null ise, mevcut atanan kişiyi bul
